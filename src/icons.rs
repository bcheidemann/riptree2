...
pub static ICON_DIR: &str = "\u{f07b} ";

pub static ICONS_BY_EXTENSION: phf::Map<&'static str, &'static str> = phf::phf_map! {
    "bsl" => "_bsl",
    "mdo" => "_mdo",
    "cls" => "_salesforce",
    "apex" => "_salesforce",
...
pub static ICONS_BY_FILE_NAME: phf::Map<&'static str, &'static str> = phf::phf_map! {
    "mix" => "_hex",
...
pub static ICONS_BY_LANGUAGE: phf::Map<&'static str, &'static str> = phf::phf_map! {
    "bat" => "_windows",
    "clojure" => "_clojure",
